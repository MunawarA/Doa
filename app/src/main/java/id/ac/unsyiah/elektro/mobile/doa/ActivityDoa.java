 ...
 */
public class ActivityDoa extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final int pesanStr = pesan.getIntExtra("var1", 0);

        final ImageView img = (ImageView) findViewById(R.id.imgHasil);
        img.setImageResource(pesanStr);
    ...
    private void play() {
        /** Memanggil File MP3 */
        Intent pesan = getIntent();
        int pesanStr1 = pesan.getIntExtra("var2", 0);
        mp = MediaPlayer.create(this, pesanStr1);
